...
export default function PipelineClient({ initialStages }: PipelineClientProps) {
    // Initialize with server-fetched data - no loading state needed!
    ...
    useEffect(() => {
        // Poll for updates every 30 seconds (initial data already loaded via SSR)
